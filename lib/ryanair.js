...
program
  .command("destinations [from]")
  .description("Get destinations for a specific airport")
  .option(
    "--type [type]",
    "Which type of results should you display",
    /^(airport|country|city|all)$/,
    "all"
  )
  .action(cli.destinations);
