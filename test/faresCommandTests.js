...
module.exports = function() {
    ...
    describe('Filters', function () {
        describe('Filter by time', function () {
    ...
    describe('Content', function () {
        ...
        describe('Search flights', function () {
            ...
            it('should return a flight with departure at 06:20 when filtering for flights leaving before 06:30', function () {
                ...
                filteredFlights[0].should.include({
                    "departure": "06:20:00"
                })
            })
            ...
            it('should sort results by date asc', function () {
                ...
                for (let i = 1, nDates = flightDates.length; i < nDates; i++) {
            ...
            it('should sort results by price desc', function () {
                ...
                for (let i = 0, n = flightPrices.length; i < n - 1; i++) {
